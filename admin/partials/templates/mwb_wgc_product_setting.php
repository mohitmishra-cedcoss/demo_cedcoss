	...
	<tbody>
		...
		<tr valign="top">
			<th scope="row" class="titledesc">
				<label for="mwb_wgm_product_setting_giftcard_ex_sale"><?php _e('Exclude Sale Items', 'woocommerce_gift_cards_lite')?></label>
			</th>
			<td class="forminp forminp-text">
				...
				<label for="mwb_wgm_product_setting_giftcard_ex_sale">
					<input type="checkbox" <?php echo ($giftcard_ex_sale == 'yes')?"checked='checked'":""?> name="mwb_wgm_product_setting_giftcard_ex_sale" id="mwb_wgm_product_setting_giftcard_ex_sale" class="input-text" value="yes"> <?php _e('Enable to exclude Sale Items','woocommerce_gift_cards_lite');?>
				</label>
			</td>
		</tr>
		<tr valign="top">
			<th scope="row" class="titledesc">
				<label for="mwb_wgm_product_setting_exclude_product"><?php _e('Exclude Products', 'woocommerce_gift_cards_lite')?></label>
			</th>
			<td class="forminp forminp-text">
			<?php 
				...
				?>
				<p class="form-field">
					<input type="hidden" class="wc-product-search" data-multiple="true" style="width: 50%;" name="mwb_wgm_product_setting_exclude_product" data-placeholder="<?php esc_attr_e( 'Search for a product&hellip;', 'woocommerce_gift_cards_lite' ); ?>" data-action="woocommerce_json_search_products_and_variations" data-selected="<?php
		...
		<tr valign="top">
			<th scope="row" class="titledesc">
				<label for="mwb_wgm_product_setting_exclude_category"><?php _e('Exclude Product Category', 'woocommerce_gift_cards_lite')?></label>
			</th>
			<td class="forminp forminp-text">
				<?php 
...
<p class="submit">
	<input type="submit" value="<?php _e('Save changes','woocommerce_gift_cards_lite');?>" class="button-primary woocommerce-save-button" name="mwb_wgm_product_setting_save">
</p>
