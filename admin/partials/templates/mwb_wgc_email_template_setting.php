...
if(isset($_POST['mwb_wgm_other_setting_save']))
{
	...
	?>
	<h2 class="mwb_wgm_overview_heading"><?php _e('Create Custom Email Template', 'woocommerce_gift_cards_lite')?></h2>
	<div class="mwb_wgm_table_wrapper">
		<div id="mwb_wgm_manage_template_wrapper">
			<div class="postbox" id="mwb_wgm_mail_instruction" style="display: block;">
				<h3 class="hndle"><span><?php _e('Instruction for using Shortcode', 'woocommerce_gift_cards_lite');?></span></h3>
				<div class="inside">
				...
				<tbody>
					<tr valign="top">
						<th scope="row" class="titledesc">
							<label for="mwb_wgm_other_setting_upload_logo"><?php _e('Upload Default Logo', 'woocommerce_gift_cards_lite')?></label>
						</th>
						<td class="forminp forminp-text">
							...
							?>
							<input type="text" readonly class="mwb_wgm_other_setting_upload_logo_value mwb_wgm_new_woo_ver_style_text" id="mwb_wgm_other_setting_upload_logo" name="mwb_wgm_other_setting_upload_logo" value="<?php echo $mwb_wgm_other_setting_upload_logo;?>"/>
							<input class="mwb_wgm_other_setting_upload_logo button"  type="button" value="<?php _e('Upload Logo','woocommerce_gift_cards_lite');?>" />
					...
					<tr valign="top">
						<th scope="row" class="titledesc">
							<label for="mwb_wgm_other_setting_giftcard_subject"><?php _e('Giftcard Email Subject', 'woocommerce_gift_cards_lite')?></label>
						</th>
						<td class="forminp forminp-text">
							...
							<p class="description"><?php _e('Use [BUYEREMAILADDRESS] shortcode as buyer email address to be placed dynamically.', 'woocommerce_gift_cards_lite');?></p>					
						</td>
					</tr>
					<tr valign="top">
						<th scope="row" class="titledesc">
							<label for="mwb_wgm_other_setting_giftcard_html"><?php _e('Custom HTML', 'woocommerce_gift_cards_lite')?></label>
						</th>
						<td class="forminp forminp-text">
							<?php 
	...
	<p class="submit mwb_wgm_email_template">
		<input type="submit" value="<?php _e('Save changes','woocommerce_gift_cards_lite'); ?>" class="button-primary woocommerce-save-button" name="mwb_wgm_other_setting_save">
	</p>
	<div class="clear"></div>
